...
bool CardTheme::operator==(const CardTheme& other) const
{
    if(this->name == other.getName()) return true;
    return false;
}

bool CardTheme::operator==(const std::shared_ptr<CardTheme> other) const
{
    if(this->name == other->getName()) return true;
    return false;
}
 ...
 */
CardGoal::CardGoal(std::string name, sf::Texture& t, std::vector<std::shared_ptr<CardTheme>>& themes, 
...
const std::vector<std::shared_ptr<CardTheme>> CardGoal::getThemes() const
{
    return this->themes;
}
